...
public class GameStart {
	...
	protected void createContents() {
		...
		btn_back.setBounds(304, 346, 132, 44);
		...
		btn_easy.setFont((Font) localResourceManager.create(FontDescriptor.createFrom("Microsoft YaHei UI", 10, SWT.BOLD)));
		...
		btn_middle.setFont((Font) localResourceManager.create(FontDescriptor.createFrom("Microsoft YaHei UI", 10, SWT.BOLD)));
		...
		btn_hard.setFont((Font) localResourceManager.create(FontDescriptor.createFrom("Microsoft YaHei UI", 10, SWT.BOLD)));
		...
		btn_customize.setFont((Font) localResourceManager.create(FontDescriptor.createFrom("Microsoft YaHei UI", 10, SWT.BOLD)));
		...
		btn_customize.setBackground((Color) localResourceManager.create(ColorDescriptor.createFrom(new RGB(148, 0, 211))));
		
		
		
		Label lbl_mode = new Label(shell, SWT.NONE);
		lbl_mode.setFont((Font) localResourceManager.create(FontDescriptor.createFrom("Microsoft YaHei UI", 15, SWT.BOLD)));
